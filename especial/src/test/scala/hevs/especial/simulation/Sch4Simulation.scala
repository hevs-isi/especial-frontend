 ...
 *
 * The [[Sch4SimCode]] is simulated in QEMU. After 6 loop ticks, output values are exported in a VCD file.
 ...
 */
class Sch4Simulation extends MonitorTest {

  /** DSL program under test. */
  runTests(new Sch4SimCode())
}
