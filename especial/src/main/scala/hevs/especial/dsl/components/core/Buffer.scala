...
// FIXME: Not necessary any more. Custom C block with variable or static function is fine for now
case class Buffer[T <: CType : TypeTag](value: T) extends Component with Out1 with HwImplemented {
